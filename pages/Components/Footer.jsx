    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <div>
        ...
        <ul className="mt-6 space-y-4 text-sm">
          <li><a href="services" className="hover:text-white">Continuous Security Monitoring</a></li>
          <li><a href="services" className="hover:text-white">Antivirus/Endpoint Detection</a></li>
          <li><a href="services" className="hover:text-white">Remote Monitoring</a></li>
          <li><a href="services" className="hover:text-white">Vulnerability Management and Patching</a></li>
          <li><a href="services" className="hover:text-white">Incident Response</a></li>
          <li><a href="services" className="hover:text-white">Security Awareness Training</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="mt-6 space-y-4 text-sm">
          <li><a href="first" className="hover:text-white">About</a></li>
          <li><a href="blog" className="hover:text-white">Meet the Team</a></li>
          <li><a href="Review" className="hover:text-white">Accounts Review</a></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div className="mt-12 border-t border-gray-700 pt-12">
    <div className="sm:flex sm:items-center sm:justify-between">
      <ul className="flex flex-wrap gap-4 text-xs">
        ...
        <li><a href="Cookie" className="text-gray-400 hover:text-white">Cookies</a></li>
      </ul>
      <p className="mt-8 text-xs text-gray-400 sm:mt-0">&copy; 2022. Company Name. All rights reserved.</p>
    </div>
  </div>
</footer>
